...
This directory contains the videos with accessible YouTube links below them. 
...
Although the video does not contain any explaination, but it shows the record of the run of the robot.
